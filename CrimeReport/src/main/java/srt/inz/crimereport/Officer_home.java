...
public class Officer_home extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.officerhome);
	
		bvah=(Button)findViewById(R.id.button_vahelp2);
		bvcr=(Button)findViewById(R.id.button_vcrime2);
		
		mylist=(ListView)findViewById(R.id.mlist_news012);
		apppref=(ApplicationPreference)getApplication();
		imb=(ImageButton)findViewById(R.id.img_btadd012);
	    	...
	    	if(st.equals("0"))
	    	{
	    		alertDialogBuilder.setNegativeButton("Approve", new DialogInterface.OnClickListener() {
	   	         ...
	   	         public void onClick(DialogInterface arg0, int arg1) {
	   	            ...
	   	            Toast.makeText(getApplicationContext(),"Contact admin to approve.",Toast.LENGTH_SHORT).show();
